...
class FindGenreAdapter(private val postList: ArrayList<GenreModel>, private val mCtx: Context) :
    RecyclerView.Adapter<FindGenreAdapter.PostViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        ...
        holder.txt_class_name.setText(post.genre_name)
