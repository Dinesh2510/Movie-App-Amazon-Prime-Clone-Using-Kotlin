...
import com.movie.app.Adapter.PlayerViewHolder;
...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    private CardView mediaContainer;
     ...
     */
    // Media List
    private ArrayList<MovieModel> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (mediaUrl != null) {
            MediaSource videoSource = new ExtractorMediaSource.Factory(dataSourceFactory)
                    .createMediaSource(Uri.parse(API.movie_video + mediaUrl));
    ...
    public void setMediaObjects(ArrayList<MovieModel> mediaObjects) {
